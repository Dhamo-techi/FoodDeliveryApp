...
class JuiceItemVC: UIViewController {
...
extension JuiceItemVC : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
